export const imagesAvatars = [
  ...
  // {
  //   original: `${process.env.PUBLIC_URL}/images/MLAvatars/Cyla2-watermark.png`,
  //   thumbnail: `${process.env.PUBLIC_URL}/images/MLAvatars/Cyla2-watermark.png`,
...
export const imagesOverlaysWaterDeep = [
  {
    original:
...
export const imagesOverlayVanessa = [
  {
    original:
